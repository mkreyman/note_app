defmodule NoteAppWeb.NoteLiveTest do
  ...
  import NoteApp.NotesFixtures

  @create_attrs %{content: "some content", note_taker_id: "7488a646-e31f-11e4-aace-600308960662", title: "some title"}
  @update_attrs %{content: "some updated content", note_taker_id: "7488a646-e31f-11e4-aace-600308960668", title: "some updated title"}
  @invalid_attrs %{content: nil, note_taker_id: nil, title: nil}
